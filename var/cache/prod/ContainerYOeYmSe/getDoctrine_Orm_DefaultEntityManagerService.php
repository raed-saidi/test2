...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelProdDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost35f0d92', static fn () => \EntityManagerGhost35f0d92::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
